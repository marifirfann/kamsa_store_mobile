...
class ProfileView extends StatelessWidget {
  ...
  void _showEditProfileModal(BuildContext context) {
    ...
    final TextEditingController emailController = TextEditingController(text: controller.userEmail.value);
    final TextEditingController passwordController = TextEditingController();

    showModalBottomSheet(
      context: context,
      builder: (BuildContext context) {
        return SingleChildScrollView( // Make the modal scrollable
          child: Padding(
              ...
              children: [
                ...
                Center(
                  child: GestureDetector(
                    ...
                    child: CircleAvatar(
                      ...
                      backgroundImage: AssetImage(controller.userImage.value),
                ...
                ElevatedButton(
                  ...
                  style: ElevatedButton.styleFrom(
                    backgroundColor: Color(0xFF222222), // Black background for button
        ...
        child: Column(
          children: [
            Center(
              child: CircleAvatar(
              radius: 60,
              backgroundColor: Colors.white, // Warna latar belakang jika image belum tersedia
              backgroundImage: AssetImage(controller.userImage.value),
              child: controller.userImage.value.isEmpty // Jika gambar kosong, tampilkan ikon
                  ? Icon(Icons.person, size: 40, color: Colors.white)
                  : null, // Menampilkan gambar jika tersedia
            )
            ),
            const SizedBox(height: 20),
            Obx(() => Text(
